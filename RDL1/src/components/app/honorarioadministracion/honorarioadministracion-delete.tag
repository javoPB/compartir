...
<honorarioadministracion-delete>
	<page id="honorarioadministracion-delete" title="Eliminar Honorario por administración">
		<formbox title="Datos de Honorario por administración" icon="fa fa-check-circle-o" action="delete" return="honorarioAdministracion-admin">
			<div class="row">
