...
<honorarioadministracion-add>
	<page id="honorarioadministracion-add" title="Agregar Honorario por administración">
		<formbox title="Datos de Honorario por administración" icon="fa fa-check-circle-o" action="create" return="honorarioAdministracion-admin">
			<div class="row">
