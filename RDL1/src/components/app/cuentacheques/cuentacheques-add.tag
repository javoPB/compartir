...
<cuentacheques-add>
	<page id="cuentacheques-add" title="Agregar Cuenta de cheques">
		<formbox title="Datos de Cuenta de cheques" icon="fa fa-check-circle-o" action="create" return="cuentaCheques-admin">
			<div class="row">
