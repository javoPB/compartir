...
<cuentacheques-edit>
	<page id="cuentacheques-edit" title="Editar Cuenta de cheques">
		<formbox title="Datos de Cuenta de cheques" icon="fa fa-check-circle-o" action="update" return="cuentaCheques-admin">
			<div class="row">
