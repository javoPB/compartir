...
<fideicomisario-add>
	<page id="fideicomisario-add" title="Agregar Fideicomisario">
		<formbox title="Datos de Fideicomisario" icon="fa fa-check-circle-o" action="create" return="fideicomisario-admin">
			<div class="row">
				<div class="col-md-6">	
