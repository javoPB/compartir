...
<fideicomisario-edit>
	<page id="fideicomisario-edit" title="Editar Fideicomisario">
		<formbox title="Datos de Fideicomisario" icon="fa fa-check-circle-o" action="update" return="fideicomisario-admin">
			<div class="row">
				<div class="col-md-6">	
