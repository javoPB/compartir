...
<formasliquidacion-delete>
	<page id="formasliquidacion-delete" title="Eliminar Formas de Liquidación">
		<formbox title="Datos de Formas de liquidación" icon="fa fa-check-circle-o" action="delete" return="formasLiquidacion-admin">
			<div class="row">
