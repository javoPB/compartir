...
<formasliquidacion-edit>
	<page id="formasliquidacion-edit" title="Editar Formas de liquidación">
		<formbox title="Datos de Formas de liquidación" icon="fa fa-check-circle-o" action="update" return="formasLiquidacion-admin">
			<div class="row">
