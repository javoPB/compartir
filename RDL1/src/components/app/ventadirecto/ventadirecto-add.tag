...
<ventadirecto-add>
	<page id="ventadirecto-add" title="Agregar Instrucción de venta de valores">
		<formbox title="Datos de Instrucción de venta de valores" icon="fa fa-check-circle-o" action="create" return="ventaDirecto-admin">
			<div class="row">
