...
<ventadirecto-edit>
	<page id="ventadirecto-edit" title="Editar Instrucción de venta de valores">
		<formbox title="Datos de Instrucción de venta de valores" icon="fa fa-check-circle-o" action="update" return="ventaDirecto-admin">
			<div class="row">
