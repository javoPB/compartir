...
<ventadirecto-delete>
	<page id="ventadirecto-delete" title="Eliminar Instrucción de venta de valores">
		<formbox title="Datos de Instrucción de venta de valores" icon="fa fa-check-circle-o" action="delete" return="ventaDirecto-admin">
			<div class="row">
