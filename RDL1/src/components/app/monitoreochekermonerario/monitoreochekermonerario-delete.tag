...
<monitoreochekermonerario-delete>
	<page id="monitoreochekermonerario-delete" title="Eliminar Monitoreo de Instrucciones de checker monetario">
		<formbox title="Datos de Monitoreo de instrucciones de checker monetario" icon="fa fa-check-circle-o" action="delete" return="monitoreoChekerMonerario-admin">
			<div class="row">
