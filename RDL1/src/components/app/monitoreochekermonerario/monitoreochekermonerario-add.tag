...
<monitoreochekermonerario-add>
	<page id="monitoreochekermonerario-add" title="Agregar Monitoreo de instrucciones de checker monetario">
		<formbox title="Datos de Monitoreo de instrucciones de checker monetario" icon="fa fa-check-circle-o" action="create" return="monitoreoChekerMonerario-admin">
			<div class="row">
