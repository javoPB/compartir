...
<honorarioscontrato-add>
	<page id="honorarioscontrato-add" title="Agregar Cartera honorarios por contrato">
		<formbox title="Datos de Cartera honorarios por contrato" icon="fa fa-check-circle-o" action="create" return="honorariosContrato-admin">
			<div class="row">
