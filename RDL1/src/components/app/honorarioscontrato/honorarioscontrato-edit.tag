...
<honorarioscontrato-edit>
	<page id="honorarioscontrato-edit" title="Editar Cartera honorarios por contrato">
		<formbox title="Datos de Cartera honorarios por contrato" icon="fa fa-check-circle-o" action="update" return="honorariosContrato-admin">
			<div class="row">
