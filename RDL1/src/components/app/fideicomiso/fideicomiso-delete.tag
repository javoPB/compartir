...
<fideicomiso-delete>
	<page id="fideicomiso-delete" title="Eliminar Fideicomiso">
		<formbox title="Datos de Fideicomiso" icon="fa fa-check-circle-o" action="delete" return="fideicomiso-admin">
			<div class="row">
