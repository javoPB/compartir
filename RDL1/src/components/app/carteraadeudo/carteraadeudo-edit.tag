...
<carteraadeudo-edit>
	<page id="carteraadeudo-edit" title="Editar Cartera adeudos">
		<formbox title="Datos de Cartera adeudos" icon="fa fa-check-circle-o" action="update" return="carteraAdeudo-admin">
			<div class="row">
