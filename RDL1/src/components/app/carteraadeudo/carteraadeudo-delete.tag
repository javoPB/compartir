...
<carteraadeudo-delete>
	<page id="carteraadeudo-delete" title="Eliminar Cartera adeudos">
		<formbox title="Datos de Cartera adeudos" icon="fa fa-check-circle-o" action="delete" return="carteraAdeudo-admin">
			<div class="row">
