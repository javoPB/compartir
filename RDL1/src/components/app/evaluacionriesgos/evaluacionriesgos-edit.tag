...
<evaluacionriesgos-edit>
	<page id="evaluacionriesgos-edit" title="Editar Resultados de la evaluación de riesgos">
		<formbox title="Datos de Resultados de la evaluación de riesgos" icon="fa fa-check-circle-o" action="update" return="evaluacionRiesgos-admin">
			<div class="row">
				<div class="col-md-6">	
