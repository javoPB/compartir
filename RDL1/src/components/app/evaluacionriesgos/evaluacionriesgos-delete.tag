...
<evaluacionriesgos-delete>
	<page id="evaluacionriesgos-delete" title="Eliminar Resultados de la Evaluación de Riesgos">
		<formbox title="Datos de Resultados de la evaluación de riesgos" icon="fa fa-check-circle-o" action="delete" return="evaluacionRiesgos-admin">
			<div class="row">
				<div class="col-md-6">	
