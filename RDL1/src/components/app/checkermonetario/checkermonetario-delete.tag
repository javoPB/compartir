...
<checkermonetario-delete>
	<page id="checkermonetario-delete" title="Eliminar Monetario">
		<formbox title="Datos de Monetario" icon="fa fa-check-circle-o" action="delete" return="checkerMonetario-admin">
			<div class="row">
				<div class="col-md-6">	
