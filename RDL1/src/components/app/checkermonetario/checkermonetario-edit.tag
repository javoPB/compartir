...
<checkermonetario-edit>
	<page id="checkermonetario-edit" title="Editar Monetario">
		<formbox title="Datos de Monetario" icon="fa fa-check-circle-o" action="update" return="checkerMonetario-admin">
			<div class="row">
				<div class="col-md-6">	
