...
<declaracionsat-delete>
	<page id="declaracionsat-delete" title="Eliminar Generación archivo SAT 32-B">
		<formbox title="Datos de Generación archivo sat 32-b" icon="fa fa-check-circle-o" action="delete" return="declaracionSat-admin">
			<div class="row">
				<div class="col-md-6">
