...
<declaracionsat-edit>
	<page id="declaracionsat-edit" title="Editar Generación archivo sat 32-b">
		<formbox title="Datos de Generación archivo sat 32-b" icon="fa fa-check-circle-o" action="update" return="declaracionSat-admin">
			<div class="row">
				<div class="col-md-6">
