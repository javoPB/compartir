...
<fideicomisospendientesliberar-add>
	<page id="fideicomisospendientesliberar-add" title="Agregar Fideicomisos pendientes de liberar">
		<formbox title="Datos de Fideicomisos pendientes de liberar" icon="fa fa-check-circle-o" action="create" return="fideicomisosPendientesLiberar-admin">
			<div class="row">
