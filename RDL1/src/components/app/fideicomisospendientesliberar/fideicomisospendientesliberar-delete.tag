...
<fideicomisospendientesliberar-delete>
	<page id="fideicomisospendientesliberar-delete" title="Eliminar Fideicomisos Pendientes de Liberar">
		<formbox title="Datos de Fideicomisos pendientes de liberar" icon="fa fa-check-circle-o" action="delete" return="fideicomisosPendientesLiberar-admin">
			<div class="row">
