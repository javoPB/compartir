...
<autodeclaracioncrs-delete>
	<page id="autodeclaracioncrs-delete" title="Eliminar Autodeclaración CRS">
		<formbox title="Datos de Autodeclaración crs" icon="fa fa-check-circle-o" action="delete" return="autodeclaracionCrs-admin">
			<div class="row">
