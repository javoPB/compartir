...
<autodeclaracioncrs-add>
	<page id="autodeclaracioncrs-add" title="Agregar Autodeclaración crs">
		<formbox title="Datos de Autodeclaración crs" icon="fa fa-check-circle-o" action="create" return="autodeclaracionCrs-admin">
			<div class="row">
