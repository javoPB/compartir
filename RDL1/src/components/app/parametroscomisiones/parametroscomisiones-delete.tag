...
<parametroscomisiones-delete>
	<page id="parametroscomisiones-delete" title="Eliminar Parámetros de comisiones">
		<formbox title="Datos de Parámetros de comisiones" icon="fa fa-check-circle-o" action="delete" return="parametrosComisiones-admin">
			<div class="row">
