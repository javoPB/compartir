...
<parametroscomisiones-add>
	<page id="parametroscomisiones-add" title="Agregar Parámetros de comisiones">
		<formbox title="Datos de Parámetros de comisiones" icon="fa fa-check-circle-o" action="create" return="parametrosComisiones-admin">
			<div class="row">
