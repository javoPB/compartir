...
<fideicomitente-add>
	<page id="fideicomitente-add" title="Agregar Fideicomitente">
		<formbox title="Datos de Fideicomitente" icon="fa fa-check-circle-o" action="create" return="fideicomitente-admin">
			<div class="row">
				<div class="col-md-6">	
