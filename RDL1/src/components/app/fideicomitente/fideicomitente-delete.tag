...
<fideicomitente-delete>
	<page id="fideicomitente-delete" title="Eliminar Fideicomitente">
		<formbox title="Datos de Fideicomitente" icon="fa fa-check-circle-o" action="delete" return="fideicomitente-admin">
			<div class="row">
				<div class="col-md-6">	
