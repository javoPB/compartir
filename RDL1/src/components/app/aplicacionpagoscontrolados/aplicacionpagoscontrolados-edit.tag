...
<aplicacionpagoscontrolados-edit>
	<page id="aplicacionpagoscontrolados-edit" title="Editar Aplicación de pagos controlados">
		<formbox title="Datos de Aplicación de pagos controlados" icon="fa fa-check-circle-o" action="update" return="aplicacionPagosControlados-admin">
			<div class="row">
