...
<aplicacionpagoscontrolados-add>
	<page id="aplicacionpagoscontrolados-add" title="Agregar Aplicación de pagos controlados">
		<formbox title="Datos de Aplicación de pagos controlados" icon="fa fa-check-circle-o" action="create" return="aplicacionPagosControlados-admin">
			<div class="row">
