...
<transaccion-delete>
	<page id="transaccion-delete" title="Eliminar Catálogo de transacciones">
		<formbox title="Datos de Catálogo de transacciones" icon="fa fa-check-circle-o" action="delete" return="transaccion-admin">
			<div class="row">
				<div class="col-md-6">	
