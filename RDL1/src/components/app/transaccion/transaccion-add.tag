...
<transaccion-add>
	<page id="transaccion-add" title="Agregar Catálogo de transacciones">
		<formbox title="Datos de Catálogo de transacciones" icon="fa fa-check-circle-o" action="create" return="transaccion-admin">
			<div class="row">
				<div class="col-md-6">	
