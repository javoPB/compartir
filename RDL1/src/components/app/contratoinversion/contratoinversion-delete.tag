...
<contratoinversion-delete>
	<page id="contratoinversion-delete" title="Eliminar Contratos de inversión">
		<formbox title="Datos de Contratos de inversión" icon="fa fa-check-circle-o" action="delete" return="contratoInversion-admin">
			<div class="row">
