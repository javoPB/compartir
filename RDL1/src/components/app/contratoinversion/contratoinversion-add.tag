...
<contratoinversion-add>
	<page id="contratoinversion-add" title="Agregar Contratos de inversión">
		<formbox title="Datos de Contratos de inversión" icon="fa fa-check-circle-o" action="create" return="contratoInversion-admin">
			<div class="row">
