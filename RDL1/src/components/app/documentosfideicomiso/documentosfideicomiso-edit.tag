...
<documentosfideicomiso-edit>
	<page id="documentosfideicomiso-edit" title="Editar Check list de documentos del fideicomiso">
		<formbox title="Datos de Check list de documentos del fideicomiso" icon="fa fa-check-circle-o" action="update" return="documentosFideicomiso-admin">
			<div class="row">
				<div class="col-md-6">	
