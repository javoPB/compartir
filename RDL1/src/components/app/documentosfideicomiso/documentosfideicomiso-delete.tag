...
<documentosfideicomiso-delete>
	<page id="documentosfideicomiso-delete" title="Eliminar Check list de documentos del fideicomiso">
		<formbox title="Datos de Check list de documentos del fideicomiso" icon="fa fa-check-circle-o" action="delete" return="documentosFideicomiso-admin">
			<div class="row">
				<div class="col-md-6">	
