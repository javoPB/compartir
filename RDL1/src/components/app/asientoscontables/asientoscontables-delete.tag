...
<asientoscontables-delete>
	<page id="asientoscontables-delete" title="Eliminar Asientos contables">
		<formbox title="Datos de Asientos contables" icon="fa fa-check-circle-o" action="delete" return="asientosContables-admin">
			<div class="row">
				<div class="col-md-6">	
