...
<asientoscontables-edit>
	<page id="asientoscontables-edit" title="Editar Asientos contables">
		<formbox title="Datos de Asientos contables" icon="fa fa-check-circle-o" action="update" return="asientosContables-admin">
			<div class="row">
				<div class="col-md-6">	
