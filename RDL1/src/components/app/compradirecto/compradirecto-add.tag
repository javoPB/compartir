...
<compradirecto-add>
	<page id="compradirecto-add" title="Agregar Instrucción de compra de valores">
		<formbox title="Datos de Instrucción de compra de valores" icon="fa fa-check-circle-o" action="create" return="compraDirecto-admin">
			<div class="row">
