...
<compradirecto-delete>
	<page id="compradirecto-delete" title="Eliminar Instrucción de compra de valores">
		<formbox title="Datos de Instrucción de compra de valores" icon="fa fa-check-circle-o" action="delete" return="compraDirecto-admin">
			<div class="row">
