...
<aportaciones-add>
	<page id="aportaciones-add" title="Agregar Aportaciones">
		<formbox title="Datos de Aportaciones" icon="fa fa-check-circle-o" action="create" return="aportaciones-admin">
			<div class="row">
