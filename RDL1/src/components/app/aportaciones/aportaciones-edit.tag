...
<aportaciones-edit>
	<page id="aportaciones-edit" title="Editar Aportaciones">
		<formbox title="Datos de Aportaciones" icon="fa fa-check-circle-o" action="update" return="aportaciones-admin">
			<div class="row">
