...
<saldoscuenta-add>
	<page id="saldoscuenta-add" title="Agregar Saldos por cuenta">
		<formbox title="Datos de Saldos por cuenta" icon="fa fa-check-circle-o" action="create" return="saldosCuenta-admin">
			<div class="row">
