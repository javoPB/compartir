...
<saldoscuenta-edit>
	<page id="saldoscuenta-edit" title="Editar Saldos por cuenta">
		<formbox title="Datos de Saldos por cuenta" icon="fa fa-check-circle-o" action="update" return="saldosCuenta-admin">
			<div class="row">
