...
<saldoscuenta-form>
				...
				<p hidden>11</p>
					...
					<div class="col-md-6">	
						...
						<inputbox id="SaldoInicial" type="text" label="Saldo inicial" value="" placeholder="" required=false disabled=false />
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6">	
						...
						<inputbox id="Cargos" type="text" label="Cargos" value="" placeholder="" required=false disabled=false />
					</div>
				...
				<p hidden>13</p>
					...
					<div class="col-md-6">	
						...
						<inputbox id="Abonos" type="text" label="Abonos" value="" placeholder="" required=false disabled=false />
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6">	
						...
						<inputbox id="SaldoActual" type="text" label="Saldo actual" value="" placeholder="" required=false disabled=false />
					</div>
				</div>
