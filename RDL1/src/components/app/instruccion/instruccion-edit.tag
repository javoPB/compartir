...
<instruccion-edit>
	<page id="instruccion-edit" title="Editar Instrucciones">
		<formbox title="Datos de Instrucciones" icon="fa fa-check-circle-o" action="update" return="instruccion-admin">
			<div class="row">
				<div class="col-md-6">	
