...
<instruccion-add>
	<page id="instruccion-add" title="Agregar Instrucciones">
		<formbox title="Datos de Instrucciones" icon="fa fa-check-circle-o" action="create" return="instruccion-admin">
			<div class="row">
				<div class="col-md-6">	
