...
<compraventavalores-delete>
	<page id="compraventavalores-delete" title="Eliminar Solicitud compra - venta de valores">
		<formbox title="Datos de Solicitud compra - venta de valores" icon="fa fa-check-circle-o" action="delete" return="compraVentaValores-admin">
			<div class="row">
				<div class="col-md-6">
