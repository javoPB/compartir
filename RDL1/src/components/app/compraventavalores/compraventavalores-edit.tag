...
<compraventavalores-edit>
	<page id="compraventavalores-edit" title="Editar Solicitud compra - venta de valores">
		<formbox title="Datos de Solicitud compra - venta de valores" icon="fa fa-check-circle-o" action="update" return="compraVentaValores-admin">
			<div class="row">
				<div class="col-md-6">
