...
<usuario-edit>
	<page id="usuario-edit" title="Editar Usuario">
		<formbox title="Datos de Usuario" icon="fa fa-check-circle-o" action="update" return="/administradorpendientes/usuario/usuario-admin">
			<div class="row">
				<div class="col-md-6">	
