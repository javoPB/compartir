...
<pedidogeneralaut-edit>
	<page id="pedidogeneralaut-edit" title="Editar Pedido general">
		<formbox title="Datos de Pedido general" icon="fa fa-check-circle-o" action="update" return="/autorizar/pedidogeneralaut/pedidoGeneralAut-admin">
			<div class="row">
