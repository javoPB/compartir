...
<pendienteautorizargeneralaut-edit>
	<page id="pendienteautorizargeneralaut-edit" title="Editar Pendiente autorizar general">
		<formbox title="Datos de Pendiente autorizar general" icon="fa fa-check-circle-o" action="update" return="/autorizar/pendienteautorizargeneralaut/pendienteAutorizarGeneralAut-admin">
			<div class="row">
