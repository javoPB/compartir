...
<pendienteautorizardetalleaut-edit>
	<page id="pendienteautorizardetalleaut-edit" title="Editar Pendiente autorizar detalle">
		<formbox title="Datos de Pendiente autorizar detalle" icon="fa fa-check-circle-o" action="update" return="/autorizar/pendienteautorizardetalleaut/pendienteAutorizarDetalleAut-admin">
			<div class="row">
