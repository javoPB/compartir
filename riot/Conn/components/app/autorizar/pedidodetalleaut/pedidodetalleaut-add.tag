...
<pedidodetalleaut-add>
	<page id="pedidodetalleaut-add" title="Agregar Pedido detalle">
		<formbox title="Datos de Pedido detalle" icon="fa fa-check-circle-o" action="create" return="/autorizar/pedidodetalleaut/pedidoDetalleAut-admin">
			<div class="row">
