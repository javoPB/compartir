...
<maestrocodigoaut-edit>
	<page id="maestrocodigoaut-edit" title="Editar Maestro código">
		<formbox title="Datos de Maestro código" icon="fa fa-check-circle-o" action="update" return="/autorizar/maestrocodigoaut/maestroCodigoAut-admin">
			<div class="row">
				<div class="col-md-6">	
